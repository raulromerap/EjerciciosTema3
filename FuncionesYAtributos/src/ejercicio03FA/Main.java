...
/*
 * CASOS DE PRUEBA
 * ENTRADA: 2, 1			| ESPERA: 12.56						| OBTENIDO: El resultado es: 12.566370614359172
 * ENTRADA: 78, 2 		| ESPERA:  19113.44					| OBTENIDO: El resultado es: 19113.4497044403
 * ENTRADA: 45, 0 		| ESPERA: Salida 						| OBTENIDO: Gracias por usar este programa
 * ENTRADA: 100, h		| ESPERA: Error 						| OBTENIDO: El tipo de numero debe ser decimal
 * ENTRADA: -21,  2 		| ESPERA: 1385.44					| OBTENIDO: El resultado es: 1385.4423602330987
 */
...
public class Main {
	...
	public static void main(String[] args) {
		...
		Circulo circulo;
		//Se crea tres variables tipo double(decimal) para el radio y uno para el resultado final
		...
		//Se iguala la variable del ancho con el valor devuelto de la variable pideRadio
		radio = pideRadio();
		...
		while (opc != 0) {
			...
			switch (opc) {
			//En caso de que el usuario haya puesto "1" se llama al atributo del circunferencia y se iguala a la variable resultado
	...
	public static int menu() {
		...
		//Se imprime la primera linea para que el usuario pueda ver que el numero 1 es la opcion de circunferencia
