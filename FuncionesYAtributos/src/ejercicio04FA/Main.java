...
/*
 * CASOS DE PRUEBA
 * ENTRADA: 5 y 4, 1				| ESPERA: 100							| OBTENIDO: El resultado es: 100.0
 * ENTRADA: 10 y 40.5, 2		| ESPERA:  1010						| OBTENIDO: El resultado es: 1010.0
 * ENTRADA: 4 y 1, 0 			| ESPERA: Salida 						| OBTENIDO: Gracias por usar este programa
 * ENTRADA: 100, h				| ESPERA: Error 						| OBTENIDO: El tipo de numero debe ser decimal
 * ENTRADA: -21 y 1.2,  2 		| ESPERA: 831.6						| OBTENIDO: El resultado es: 831.6
 */
...
public class Main {
	...
	public static void main(String[] args) {
		...
		Cilindro cilindro;
		//Se crea tres variables tipo double(decimal) para el radio y la altura, y uno para el resultado final
		...
		//Se iguala la variable del ancho con el valor devuelto de la variable pideRadioBase
		radioBase = pideRadioBase();
		//Se iguala la variable del ancho con el valor devuelto de la variable altura
		altura = altura();
		...
		while (opc != 0) {
			...
			switch (opc) {
			//En caso de que el usuario haya puesto "1" se llama al atributo del volumen y se iguala a la variable resultado
			case 1 -> resultado = cilindro.volumen();
			//En caso de que el usuario haya puesto "1" se llama al atributo del area y se iguala a la variable resultado
			case 2 -> resultado = cilindro.area();
			}
	...
	public static int menu() {
		...
		int opc;
		//Se imprime la primera linea para que el usuario pueda ver que el numero 1 es la opcion de volumen
	...
	public static double pideRadioBase() {
		//Se crea una variable tipo double para recoger el valor que inserte el usuario para el radio de la base
		double radioBase = 0;
		//Se crea una variable tipo boolean para saber si se puede seguir para el siguiente paso o no
		boolean seguir = true;
		//Se crea un bucle para empezar a imprimir por pantalla el mensaje para introducir el radio de la base
		do {
			/* 
			...
			*/
			try {
				System.out.print("Introduca el radio de la base: ");
	...
	public static double altura() {
		//Se crea una variable tipo double para recoger el valor que inserte el usuario para la altura
		double altura = 0;
		//Se crea una variable tipo boolean para saber si se puede seguir para el siguiente paso o no
		boolean seguir = true;
		//Se crea un bucle para empezar a imprimir por pantalla el mensaje para introducir la altura
		do {
			/* 
			 * Se intenta seguir el paso mostrandole el mensaje y 
			 * recogiendo el valor que el usuario quiere introducir para la operacion,
			...
			*/
			try {
				System.out.print("Introduca la altura: ");
